...
<main>
    <div class="container">
       ...
       <div class="row">
           ...
           <div class="col-md-6 mb-3">
               <div class="border border-light rounded p-3 bg-light">
                 <div class="h4"><img src="images/naira-dark.png" width="40px"> Fees Details</div>

                    <ul class="list-group list-group-flush mt-3">
                      <?php 
                         $total = 0;
                         foreach ($school_fees as $key => $value) 
                         {
                           $total += $value;
                           if($key != 'id' && $key !='programme_type')
                           {
                        ?>                     
                       ...
                       ?>
                      <li class="list-group-item d-flex justify-content-between">
                        <div class="text-secondary fw-bold text-uppercase">Total:</div>
                        <p><img src="images/naira-dark.png" width="20px"> <?= number_format($total,'0','.',','); ?></p>
                      </li>
                    </ul>
                    <?php

...
<main>
    <div class="container">
       ...
       <div class="row">
           ...
           <div class="col-md-6 mb-3">
               <div class="border border-light rounded p-3 bg-light">
                 <div class="h4"><img src="images/naira-dark.png" width="40px"> Acceptance Fee</div>

                    <ul class="list-group list-group-flush mt-3">
                    <?php
                         if($other_fees['acceptance']) 
                         {
                           $amount = $other_fees['acceptance'];
                         }
                    ...
                    <?php
                      $payments = $fee_obj->get_payments($_SESSION['student']['id'],"acceptance");
                      if(in_array("acceptance",$payments))
                      {
                      ?>
